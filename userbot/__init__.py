# Copyright (C) 2021-2022 TeamReponduer.
#
# Licensed under the TeamReponduer Public License, Version 1.c (the "License");
...
ENABLE_KILLME = True
SNIPE_ID = 0
LOGGER_GROUP = os.environ.get("BOTLOG_CHATID", None)
MUTING_USERS = {}
MUTED_USERS = {}
HELPER = {}
AFKREASON = "no reason"
...
UPSTREAM_REPO_URL = "https://github.com/Repondeur/Repondeur"
...
async def update_restart_msg(chat_id, msg_id):
    ...
    message = (
        f"**Repondeur v{Repondeur_VERSION} is back up and running!**\n\n"
